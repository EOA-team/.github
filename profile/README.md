...
- [SNAP LAI](https://github.com/EOA-team/SNAP_LAI) - Python implementation of the Sentinel-2 Toolbox LAI model.
- [LAI retrieval model](https://github.com/EOA-team/LAI_retrieval_model) - Analyse effect of soil inclusion in ProSAIL with SNAP-like LAI retrieval models ona multi-year, multi-site winter wheat dataset. Provides code to extract soil data from satellite products, include them in ProSAIL to generate training data, and train NN models to retrieve LAI. (Associated to paper)
